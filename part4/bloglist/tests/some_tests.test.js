...
describe('total likes', () => {
    ...
    test('when list has no blogs, result should be zero', () => {
    ...
    test('when list has more blogs, equals sum of their likes', () => {
...
describe('blog with most likes', () => {
        test('when list has no blogs result should be empty object', () => {
            const result = listHelper.favoriteBlog(zeroBlogs)
            expect(result).toEqual({})
        })

        test('when list has one blogs result should be that blog', () => {
